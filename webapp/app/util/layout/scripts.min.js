 ...
 *
 *  * scripts.min.js
 *  * Created on 16-1-9 下午5:06 by wuyufei
 *  *
...
function configurationElm(e,t){
    ...
    $(".demo").delegate(".configuration .dropdown-menu a","click",function(e){
        ...
        var r="";
        t.find("a").each(function(){r+=$(this).attr("rel")+" "});
...
function downloadLayoutSrc(){
    ...
    $("#downloadModal textarea").val(formatSrc)}var currentDocument=null;
    var timerSave=2e3;
    var demoHtml=$(".demo").html();
    $(window).resize(function(){
        $("div.dashboard-wrapper").css("min-height",$(window).height()-90);
    ...
    $(document).ready(function(){
        ...
        $(".sidebar-nav .lyrow").draggable({connectToSortable:".demo",helper:"clone",handle:".drag",drag:function(e,t){
            ...
            t.helper.attr("style","display: block;");
        }});
        ...
        $("#layout").click(function(){
            $("div.dashboard-wrapper").removeClass("devpreview sourcepreview");
            $("div.dashboard-wrapper").addClass("layout");
            removeMenuClasses();
        ...
        $("#devpreview").click(function(){
            $("div.dashboard-wrapper").removeClass("layout sourcepreview devpreview");
            $("div.dashboard-wrapper").addClass("layout");
            //$("div.dashboard-wrapper").addClass("devpreview");
            removeMenuClasses();
            $(this).addClass("active");
            return false
        });
        $("#sourcepreview").click(function(){
            $("div.dashboard-wrapper").removeClass("layout");
            $("div.dashboard-wrapper").addClass("devpreview sourcepreview");
            removeMenuClasses();
            $(this).addClass("active");
            return false
        });
