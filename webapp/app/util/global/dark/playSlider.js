...
(function ($) {
    $.fn.playSlider = function (options) {
        ...
        $('.playSlider ul.slide-content li img').css("cssText", "height: "+playsliderwidth/2.1+"px !important;");
            ...
            var slider = {
                init: function () {
                    ...
                    if(option.preloadImages){
                        ...
                        $t.append('<img src="./app/images/global/dark/loading.gif" class="prealoadImages" />');
                        item_img.hide();
