...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : './app/images/global/dark/nicEditorIcons.png',
...
var nicEditorButton = bkClass.extend({
	...
	setBg : function(state) {
		switch(state) {
			case 'hover':
				var stateStyle = {backgroundColor : '#141618'};
				break;
			case 'active':
				var stateStyle = {backgroundColor : '#141618'};
				break;
			default:
				var stateStyle = {backgroundColor : 'transparent', borderRight : '1px solid #313436', padding : '4px 0 2px'};
		}
